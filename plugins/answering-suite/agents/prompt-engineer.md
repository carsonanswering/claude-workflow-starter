...
`/Users/taj/Documents/ObsidianVault/Prompting Best Practices/`

`/Users/taj/projs/prompting best practices/` is a symlink to it — either path resolves to the same files, so read whichever the caller names. Writes land in the vault regardless.
