...
The email skeletons already exist in `/Users/kai/Desktop/projs/answering-raise/templates/` and are enforced by `bin/gate.py`. Use them; do not re-invent a shape here.
...
```bash
cd /Users/kai/Desktop/projs/answering-raise
