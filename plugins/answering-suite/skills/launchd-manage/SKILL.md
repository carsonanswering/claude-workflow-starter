...
`answering-brief`'s per-tool local-vs-cloud split lives in `/Users/kai/Desktop/projs/answering-brief/SCHEDULING.md`; its install snippet predates this skill, so where the two differ the ritual below wins.
