...
Live examples of this exact shape: `~/Library/LaunchAgents/com.carson.answering-dayplan.plist`, `com.carson.answering-dailybrief.plist`, `com.carson.answering-compwatch.plist`.
...
<dict>
  <key>Label</key>
  <string>com.carson.JOB</string>

  <key>ProgramArguments</key>
  <array>
    <string>/bin/zsh</string>
    <string>-lc</string>
    <string>cd /Users/kai/Desktop/projs/PROJECT &amp;&amp; /Users/kai/.local/bin/claude -p "/SKILL" --permission-mode acceptEdits</string>
  </array>
  ...
  <string>/Users/kai/Desktop/projs/PROJECT/logs/JOB.log</string>
  <key>StandardErrorPath</key>
  <string>/Users/kai/Desktop/projs/PROJECT/logs/JOB.err.log</string>
...
- **`StandardOutPath` / `StandardErrorPath`** — under the job's own project, `PROJECT/logs/`, matching the live jobs (`/Users/kai/Desktop/projs/answering-brief/logs/`). Keep stdout and stderr separate here so a stack trace is not interleaved with skill output. `mkdir -p` the directory before loading.
...
Live example: `~/Library/LaunchAgents/com.answeringrnd.tracker-refresh.plist`.

```xml
  <key>ProgramArguments</key>
  <array>
    <string>/bin/bash</string>
    <string>/Users/kai/Desktop/projs/PROJECT/SCRIPT.sh</string>
  </array>

  <key>StartInterval</key><integer>900</integer>
  <key>RunAtLoad</key><true/>

  <key>StandardOutPath</key><string>/Users/kai/Desktop/projs/PROJECT/refresh.log</string>
  <key>StandardErrorPath</key><string>/Users/kai/Desktop/projs/PROJECT/refresh.log</string>
